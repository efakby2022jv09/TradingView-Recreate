		...
		823127: e => {
			var t = window.document,
				...
				i = function() {
					...
					})), (r = a.uaMatch(k)).browser && (a.browser[r.browser] = !0, a.browser.version = r.version), a.browser.webkit && (a.browser.safari = !0), c.test("Â ") && (d = /^[\s\xA0]+/, f = /[\s\xA0]+$/), e = a(t), t.addEventListener ? o = function() {
